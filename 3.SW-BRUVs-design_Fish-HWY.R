...
# or change to different proportions, but should equal no of clusters * no. depth classes, in this case = 24/3 =8
tmpHist$inclProbs <- c(2,4,2) / tmpHist$counts # 0.0005740528 0.0022727273 0.0024539877 0.0018248175
...
writeRaster(rasterIP, paste(s.dir, "InclProbs-FishHWY-d5.tif", sep='/'), overwrite = T)
...
# save to csv
write.csv(Clusters, paste(w.dir, "Fish-HWY", "FishHWY-24custers-d5.csv", sep='/'))
...
#plot(tpi)
plot(rasterIP)
plot(clustersp, pch=20, cex=0.7,col='black',add=T)

pdf(paste(w.dir, "Fish-HWY", "FishHWY-Clusters24-design5.pdf", sep='/'), height=7, width=8)
#plot(b, main = "Bathymetry - Cluster centres")
# or plot inc probs --
plot(rasterIP, main = "Inclusion probabilities - 24 Cluster centres - Design5")
...
pdf(paste(w.dir, "Fish-HWY", "FishHWY-BRUVs-Clusters24-design5.pdf", sep='/'), height=7, width=8)
plot(rasterIP, main = "Inclusion probabilities - 24 Clusters - Design5")
points(fullSample3, pch=20, cex = 0.4, col='black')
points(clustersp, pch=20, cex = 0.7, col='blue')
#plot(swnp, add=T)
dev.off()
...
pdf(paste(w.dir, "Fish-HWY", "FishHWY-Bathy-BRUVs-Clusters24-design5.pdf", sep='/'), height=7, width=8)
plot(b, main ="Bathymetry - 24 Clusters - Design5", col = rev(brewer.pal(20, "RdYlBu")))
