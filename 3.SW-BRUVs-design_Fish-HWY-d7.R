...
# save to csv
write.csv(Clusters, paste(w.dir, "Fish-HWY", "FishHWY-24custers-d7.csv", sep='/'))




pdf(paste(w.dir, "Fish-HWY", "FishHWY-Clusters24-design7.pdf", sep='/'), height=7, width=8)
#plot(b, main = "Bathymetry - Cluster centres")
# or plot inc probs --
plot(rasterIP, main = "Inclusion probabilities - 24 Cluster centres - Design7")
...
pdf(paste(w.dir, "Fish-HWY", "FishHWY-BRUVs-Clusters24-design7.pdf", sep='/'), height=7, width=8)
plot(rasterIP, main = "Inclusion probabilities - 24 Clusters - Design7")
points(fullSample3, pch=20, cex = 0.4, col='black')
points(clustersp, pch=20, cex = 0.7, col='blue')
#plot(swnp, add=T)
dev.off()
...
pdf(paste(w.dir, "Fish-HWY", "FishHWY-Bathy-BRUVs-Clusters24-design7.pdf", sep='/'), height=7, width=8)
plot(b, main ="Bathymetry - 24 Clusters - Design7", col = rev(brewer.pal(20, "RdYlBu")))
...
writeOGR(fullSample3, dsn=d.dir, layer="FHWY-BRUVS-d7", driver="ESRI Shapefile", overwrite_layer=TRUE)
#writeOGR(fullSample3, dsn=d.dir, layer=paste( "Bruvs4.8", Sys.Date(), sep="_"), driver="ESRI Shapefile", overwrite_layer=TRUE)
writeOGR(clustersp, dsn=d.dir, layer="FHWY-24clusters-d7", driver="ESRI Shapefile", overwrite_layer=TRUE)
